...
Echo["private"]("conversation.".concat(conversationId)).listen('MessageSent', function (data) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        ...
        case 1:
          ...
          _context.n = 2;
          return fetch("/chat/".concat(conversationId, "/message"), {
            method: 'POST',
            headers: {
...
function appendMessage(senderName, body, isMine, createdAt) {
  var time = createdAt ? new Date(createdAt).toLocaleTimeString([], {
    hour: '2-digit',
    minute: '2-digit'
  }) : '';
  var wrapper = document.createElement('div');
  wrapper.className = 'message-wrapper ' + (isMine ? 'mine' : 'theirs');
  wrapper.innerHTML = "\n        ".concat(!isMine ? "<div class=\"sender-name\">".concat(senderName, "</div>") : '', "\n        <div class=\"bubble\">").concat(body, "</div>\n        <div class=\"message-meta\">").concat(time, "</div>\n    ");
