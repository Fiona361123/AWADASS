                                    ...
                                    <div style="position:relative;">
                                        ...
                                        <div class="jb-dropdown" style="display:none; position:absolute; right:0; top:38px; background:#fff; border:1px solid #e5e7eb; border-radius:10px; box-shadow:0 4px 16px rgba(0,0,0,0.08); min-width:150px; z-index:99; overflow:hidden;">
                                            ...
                                            <a href="{{ route('jobs.applications', $job) }}"
                                                style="display:flex; align-items:center; gap:8px; padding:10px 14px; font-size:13px; font-weight:500; text-decoration:none; color:#1a1a2e;">
                                                ...
                                                @if($job->applications_count > 0)
                                                    <span style="background:#3B4FD8; color:#fff; font-size:11px; padding:1px 7px; border-radius:99px; margin-left:auto;">
